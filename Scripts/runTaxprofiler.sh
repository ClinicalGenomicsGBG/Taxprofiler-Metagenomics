...
SampleSheet=$1
#outDir=ClinicalSamplesTestTaxprofiler2
outDir=$2
...
#baseconfig=/medstore/Development/Metagenomics/TaxProfiler/TestSamples_FromMicro/TaxprofilerRun/Scripts/Taxprofiler-Metagenomics/configs/base.config
...
nextflow run nf-core/taxprofiler --perform_shortread_qc --shortread_qc_tool 'fastp' --perform_shortread_hostremoval --shortread_hostremoval_index $hostindex --hostremoval_reference $hostfasta --save_preprocessed_reads --perform_shortread_complexityfilter --shortread_complexityfilter_tool 'bbduk' -profile singularity --input $SampleSheet --databases $DatabaseSheet --outdir $outDir -r 1.0.1 -c $MandaloreConfig --run_kraken2 --kraken2_save_readclassification --run_diamond --run_bracken --run_krona --run_krakenuniq --krakenuniq_save_readclassifications --run_metaphlan3 --save_hostremoval_unmapped 
